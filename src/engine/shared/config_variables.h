...
MACRO_CONFIG_INT(SvTuPortTW06, sv_tu_port_tw06, 8304, 0, 0, CFGFLAG_SAVE|CFGFLAG_SERVER, "Port to use for the server (tw06 mode)")
MACRO_CONFIG_STR(SvTuAssetFile, sv_tu_assetfile, 128, "", CFGFLAG_SAVE|CFGFLAG_SERVER, "Asset file sent to clients")

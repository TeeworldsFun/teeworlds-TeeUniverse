...
//TAG_NEW_ASSET
class CAssetPath : public CGenericPath<_dontuseit::NUM_ASSETTYPES, 4, 0>
{
public:
	enum
	{
...
enum
{
	GUIRECTSTYLE_SELECTION=0,
	GUIRECTSTYLE_STAMP,
	GUIRECTSTYLE_BUTTON_DEFAULT,
	...
	GUIRECTSTYLE_LAYOUT_TOOLBAR,
	GUIRECTSTYLE_LAYOUT_VIEW,
	GUIRECTSTYLE_ENTRY_DEFAULT,
	GUIRECTSTYLE_ENTRY_DEFAULT_MOUSEOVER,
	GUIRECTSTYLE_TAB_LAYOUT,

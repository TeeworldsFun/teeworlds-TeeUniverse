...
void CAsset_Skeleton::InitFromAssetsFile(CAssetManager* pAssetManager, tu::IAssetsFile* pAssetsFile, const CStorageType* pItem)
{
	// load name
...
void CAsset_Skeleton::Unload(class CAssetManager* pAssetManager)
{

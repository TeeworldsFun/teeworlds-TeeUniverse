...
Messages = [
	...
	NetMessage("ModAPI_Sv_GuiRequestData", [
		NetIntAny("m_ID"),
		NetIntAny("m_Type"),
	]),

	NetMessage("ModAPI_Sv_GuiUIRect", [
		NetIntAny("m_ID"),
	...
	NetMessage("ModAPI_Sv_GuiButtonMenu", [
		NetIntAny("m_ID"),
		NetString("m_Text"),
	...
	NetMessage("ModAPI_Sv_GuiEditBox", [
		NetIntAny("m_ID"),
		NetArray(NetIntRange("m_Dimension", 0, 100), 4),
		NetString("m_Title"),
	...
	NetMessage("ModAPI_Sv_GuiCheckBox", [
		NetIntAny("m_ID"),
		NetArray(NetIntRange("m_Dimension", 0, 100), 4),
		NetString("m_Text"),
	...
	NetMessage("ModAPI_Sv_GuiCheckBoxNumber", [
		NetIntAny("m_ID"),
		NetArray(NetIntRange("m_Dimension", 0, 100), 4),
		NetString("m_Text"),
		NetIntAny("m_Value"),
	...
	NetMessage("ModAPI_Sv_GuiScrollbar", [
		NetIntAny("m_ID"),
		NetArray(NetIntRange("m_Dimension", 0, 100), 4),
	...
	NetMessage("ModAPI_Sv_GuiScrollbarOption", [
		NetIntAny("m_ID"),
		NetArray(NetIntRange("m_Dimension", 0, 100), 4),
		NetString("m_Text"),
	...
	NetMessage("ModAPI_Cl_GuiResponseInt", [
		NetIntAny("m_ID"),
		NetIntAny("m_Type"),
		NetIntAny("m_Value"),
	]),

	NetMessage("ModAPI_Cl_GuiResponseString", [
		NetIntAny("m_ID"),
		NetIntAny("m_Type"),
		NetString("m_Text"),
	]),
